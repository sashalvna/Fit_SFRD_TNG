...
The SFRD(Z, z) can be modeled using a 2D array (obtained from a TNG simulation) or an analytical fit to this 2D array following the methods described in https://arxiv.org/pdf/1906.08136 and https://arxiv.org/pdf/2209.03385. 

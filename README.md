...
To model BBH merger population using TNG simulation or analytical fit SFRD(Z, z) (see cosmic_int_guide.txt inside the CosmicIntegration directory for additional detail):

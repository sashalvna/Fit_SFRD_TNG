#Module to sample an COMPAS h5 file. This allows users to sample a COMPAS h5 file to contain a smaller set of systems or upsample a COMPAS h5 file (sample with replacements) to contain a larger set of systems.
...
from h5view import printSummary
from h5copy import copyHDF5File
